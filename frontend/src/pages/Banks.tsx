...
export function Banks() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <button
            ...
            className="flex-1 sm:flex-none flex justify-center items-center gap-2 px-4 py-2 bg-[#0f2240] hover:bg-[#0f2240]/70 text-white text-sm font-medium rounded-lg transition-colors border border-white/10"
          >
          ...
          <button
            ...
            className="flex-1 sm:flex-none flex justify-center items-center gap-2 px-4 py-2 bg-[#0071c5] hover:bg-[#005fa3] text-white text-sm font-medium rounded-lg transition-colors shadow-lg shadow-[#0071c5]/20 whitespace-nowrap"
          >
      ...
      {isLoading ? (
        <div className="animate-pulse bg-[#0f2240]/50 h-32 rounded-lg border border-white/5" />
      ) : banks.length === 0 ? (
        <div className="bg-[#0f2240]/50 border border-white/7 rounded-xl p-16 text-center shadow-xl">
                ...
                {banks.map((b: any) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 text-xs rounded-full bg-[#0071c5]/10 text-[#0071c5] border border-[#0071c5]/20">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2">
                        <button
                          onClick={() => openEdit(b)}
                          className="p-1.5 text-gray-400 hover:text-[#0071c5] hover:bg-[#0071c5]/10 rounded-md transition-colors"
                          title="Editar"
                        >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-[#0f2240] border border-white/7 rounded-2xl shadow-2xl w-full max-w-2xl flex flex-col max-h-[90vh]">
                ...
                {[
                  ...
                  <div key={key} className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-[#0a1628] border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#0071c5]"
                    />
                  </div>
                ))}
                ...
                <div className="space-y-2 col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#0a1628] border border-white/10 rounded-xl pl-9 pr-4 py-3 text-white text-sm focus:outline-none focus:border-[#0071c5] transition-colors font-mono"
                    />
                  </div>
              ...
              >
                Cancelar
                  ...
                  <div className="mb-4 text-left">
                    ...
                    <select
                      className="w-full bg-[#0a1628] border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:border-[#0071c5] outline-none"
