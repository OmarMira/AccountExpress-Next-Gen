...
export function AuditLogs() {
    ...
    return (
      <div className="p-8 text-white min-h-screen bg-gray-950">
        <div className="animate-pulse space-y-4">
          <div className="h-12 bg-gray-900 rounded-xl w-1/4"></div>
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex justify-between items-center bg-gray-900/50 p-8 rounded-3xl border border-gray-800">
        <div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-gray-800 hover:bg-gray-700 disabled:opacity-50 text-white rounded-2xl text-sm font-bold transition-all border border-gray-700 shadow-xl"
          >
      ...
      <div className="flex gap-4">
        <div className="flex-1 relative">
          ...
          <input 
            className="w-full bg-gray-950 border border-gray-800 p-3 pl-12 rounded-xl text-white outline-none"
            ...
            <tbody>
              {filteredLogs.map((log: any) => (
                <tr key={log.id} className="border-t border-gray-800">
                  ...
                  <td className="p-4 text-indigo-400">{log.module}</td>
